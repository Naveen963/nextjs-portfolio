...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    >
      ...
      w-[101%] h-[103%] rounded-[2.5rem]
       bg-dark rounded-br-2xl dark:bg-light
...
const Project = ({ type, title, img, link, github }) => {
  return (
    <article
     ...
     justify-center rounded-2xl border border-solid
      border-dark bg-light p-6 relative dark:bg-dark
       dark:border-light xs:p-4"
    >
      <div
        className="absolute top-0 -right-3 -z-10 
      w-[101%] h-[103%] rounded-[2rem] bg-dark
       rounded-br-2xl  dark:border-light md:-right-2 md:w-[101%] xs:h-[102%] xs:rounded-[1.5rem] "
      />
