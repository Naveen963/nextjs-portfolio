...
import ProfilePic from "../../public/images/profile/my_img1.png";
...
const about = () => {
  return (
    <>
      <Head>
        <title>Naveen Kumar Chitturi | About Page</title>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I'm Naveen Kumar Chitturi, a web developer with a passion
                for creating beautiful, functional, and user-centered digital
                experiences. With industrial experience in the field. I am
                always looking for new and innovative ways to bring my ideas and
                visions to life.
              </p>
            ...
            <div className="col-span-2 flex flex-col justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3">
              <div className="flex flex-col items-end justify-center xl:items-center ">
                <span className="flex text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl">
