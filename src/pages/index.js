...
import ProfilePic from "../../public/images/profile/Developer_img1.jpg";
    ...
    <>
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center  self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                As a skilled Software Engineer/ FrontEnd Developer, I am
              ...
              <div className="flex items-center self-start mt- lg:self-center">
                <Link
                  href="/Naveen-Kumar-Chitturi_Resume.pdf"
                  target={"_blank"}
                ...
                <Link
                  ...
                  target={"_blank"}
                  className="ml-4 text-xl font-medium capitalize text-dark underline  dark:text-light md:text-base"
                >
                  Contact
                </Link>
              </div>
        ...
        <div className="absolute right-8 bottom-8 inline-block w-24 md:hidden">
          <Image src={lightBulb} alt="Naveen" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
